...
public class Cipher {
    ...
    private static final String KEY_FILE = "ciphers/key.txt";

    public static String decrypt(String input) {
        String keyContent = FileHandler.readFile("ciphers/key.txt");
        if (keyContent == null || keyContent.isEmpty()) {
            return input; // Return input as is if key file is missing or empty
        }
